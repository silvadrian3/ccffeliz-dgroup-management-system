...
function _post(){
    ...
    $query = "INSERT INTO `activity_logs` (user_id, module, activity, verb, ip_address, browser_details, activity_date) VALUES ('" . $user_id . "', '". $module ."', '" . $activity . "', '" . $verb . "', '" . $ip . "', '" . $browser_details . "', '".$server_time."')";

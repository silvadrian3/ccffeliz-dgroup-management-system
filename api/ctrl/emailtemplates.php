...
function _post(){
    ...
    if($template == 'forgotpassword'){
        ...
        if($qresult){
            ...
            if(mysqli_num_rows($qresult)!=0){
                ...
                $body .= '<p>If you did not make this change or you believe an unauthorized person has accessed your account, please contact our team at <a href="mailto:support@quisi.net">support@quisi.net</a>.</p><br/>';
            }
        ...
        if($qresult){
            ...
            if(mysqli_num_rows($qresult)!=0){
                ...
                $body .= '<p>Dear ' . $firstname . ' ' . $lastname . '</p><br/><br/>'; 
                $body .= '<p>Congratulations! You now have access to the Kleveraft\'s Business Management App. Just click the link below and fill up your log in details.</p><br/>';
                $body .= '<p><a href="www.">kleveraft.mybmapp.net</a></p><br/><br/>';
            }
        ...
        if($qresult){
            ...
            if(mysqli_num_rows($qresult)!=0){
                ...
                $body .= '<p>Dear ' . $firstname . ' ' . $lastname . '</p><br/><br/>'; 
                $body .= '<p>Congratulations! You now have access to the Kleveraft\'s Business Management App. See below log in details:</p><br/>';
                $body .= '<p>Username: <b>' . $username . '</b></p><br/>';
    ...
    $body .= "<p>If you need additional help, feel free to contact our support team.</p><br/>";
    $body .= "<p>Sincerely,<br/>DGroup Management System - Support Team</p>";
    $body .= "</body></html>";

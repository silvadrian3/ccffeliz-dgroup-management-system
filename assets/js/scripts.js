...
window.onload = function() {
    "use strict";
    var d = new Date(),
        y = "&copy; " + d.getFullYear() + " <a href='http://q11technologies.com'>Q11 GPS Assist - Roadside Assistance App</a>";
    $('.footer-details').html(y);
    
};
*/

var baselocation = "http://localhost/ian_projects/quisi/ccf/dgroup-management";
//var baselocation = "http://35.187.245.219/ccf/dgroup-management";
